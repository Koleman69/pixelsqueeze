...
export const optimizationGoals: OptimizationGoal[] = [
  {
    id: "website-speed",
    label: "Website Speed",
    description: "Max quality per KB • responsive srcset • lazy-load ready",
    icon: Globe,
    isPaid: false,
    settings: { quality: 82, maxWidth: 1920, maxHeight: 1080, dpi: 72 },
    outputFormat: "webp",
  },
  {
    id: "email-attachment",
    label: "Email Attachment",
    description: "Strict 500 KB limit • progressive JPEG • email-safe",
    icon: Mail,
    isPaid: false,
    settings: { quality: 70, maxWidth: 800, maxHeight: 800, dpi: 72 },
    outputFormat: "jpeg",
    maxFileSizeKB: 500,
  },
  {
    id: "social-media",
    label: "Social Media",
    description: "Platform dimensions • sharpen after resize • vivid colors preserved",
    icon: Instagram,
    isPaid: false,
  ...
  },
  {
    ...
    description: "White bg normalization • 2048² square crop • size limits",
    icon: ShoppingBag,
    isPaid: true,
  ...
  },
  {
    ...
    description: "White bg • 1600² square crop • eBay / Amazon / Etsy limits",
    icon: Store,
    isPaid: true,
