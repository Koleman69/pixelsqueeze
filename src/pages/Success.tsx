...
export const Success = () => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <SEO
        title="Welcome to PixelSqueeze Pro"
        description="Your PixelSqueeze Pro subscription is active. Enjoy unlimited AI photo enhancement, batch processing, and cloud storage."
        path="/success"
        noindex
      />
